...
<table class="table table-striped" style="background-color:rgba(74, 74, 74, 0.80);border-bottom:1px solid black;border-collapse:collapse;vertical-align: middle;">
  <thead>
    <tr>
      <th style="background-color: rgba(211, 211, 211, 0.8);" data-tipo="color" >ID</th>
      ...
      <th style="width:130px;background-color: rgba(211, 211, 211, 0.8);">Fecha</th>
      <th style="width:110px;background-color: rgba(211, 211, 211, 0.8);">Owner</th>
      <th style="width:110px;background-color: rgba(211, 211, 211, 0.8);">Fecha<br>completado1</th>
      ...
      <th style="width:100px;background-color: rgba(211, 211, 211, 0.8);">Actualizar Comentarios</th> <!-- nuevo botón -->
    </tr>
  </thead>
    <tbody>
    <?php
  ...
  header.addEventListener('click', function() {
    ...
    if (tipo === 'color') {
      data.sort(function(a, b) {
        ...
        var valueA = getColorValue(colorA);
        var valueB = getColorValue(colorB);
